...
const arrow = <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="48" d="M112 184l144 144 144-144"/></svg>
...
const faqs = [
  {
    id: 1,
    question: "What is Rural Rising's role in establishing economic sustainability between farmers and consumers?",
    content: (
      <>
  ...
  {
    id: 3,
    question: "How can I purchase Rural Rising's products?",
    content: (
      <p>
  ...
  {
    id: 4,
    question: "How can I chat with Rural Rising via Social Media?",
    content: (
      <>
        <p>You can reach out to us directly on social media.</p>
        <ul className={s.socmed}>
          <li><a href="https://www.facebook.com/ruralrisingph/" target='_blank'>{facebookIcon}</a></li>
          <li><a href="https://twitter.com/ruralrisingph" target='_blank'>{xIcon}</a></li>
          <li><a href="https://www.tiktok.com/@ruralrisingph" target='_blank'>{tiktokIcon}</a></li>
          <li><a href="https://www.instagram.com/ruralrisingph/" target='_blank'>{instagramIcon}</a></li>
          <li><a href="https://www.youtube.com/@ruralrisingphilippines1993" target='_blank'>{youtubeIcon}</a></li>
        </ul>
      </>
    )
  },
  {
    id: 5,
    question: "How many locations does Rural Rising have?",
    content: (
      <p>
  ...
  {
    id: 6,
    question: "Does Rural Rising deliver products nationwide?",
    content: (
      <p>
        Currently, we only deliver in Metro Manila. We are currently in the works of various providers to expand our locations beyond Metro Manila later this year.
      </p>
    )
  },
  {
    id: 7,
    question: "How do I become a Rural Rising founding member?",
    content: (
      <p>
