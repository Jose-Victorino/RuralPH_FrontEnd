      ...
      <section className='pad-block-50'>
        <div className="container flex-col gap-30">
          ...
          <div className={cn('flex-col gap-10', s.top)}>
            ...
            <p>Please read these Terms of Use (“Terms”, “Terms of Use”) carefully before using the <Link className='text-link' to='/' onClick={() => scrollReset()}>ruralrising.com</Link> website (the “Service”) operated by Web Design & Digital Marketing Philippines (“us”, “we”, or “our”).</p>
