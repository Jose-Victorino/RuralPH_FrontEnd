...
function StoryPost() {
    ...
    return (
      <div className='flex-col gap-20'>
        ...
        <div className='ql-override ql-snow'>
          <div className='ql-editor' dangerouslySetInnerHTML={{__html: storyData.description}} />
        </div>
        {storyData.story_media &&
  ...
  return (
    <section className='container pad-block-50'>
      <Link className={cn('mb-10', s.backBtn)} to='/story' onClick={() => scrollReset()}>
