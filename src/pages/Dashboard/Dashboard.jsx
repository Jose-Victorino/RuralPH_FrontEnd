  ...
  return (
    <section className={s.container}>
      ...
      <div className='flex-col gap-30'>
        <div>
          <h4>Dashboard</h4>
          <ul className={s.mainModuleList}>
            <li className={s.moduleItem}>
              <Link to='/dashboard/event' onClick={() => scrollReset()}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            <li className={s.moduleItem}>
              <Link to='/dashboard/news' onClick={() => scrollReset()}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            <li className={s.moduleItem}>
              <Link to='/dashboard/journey' onClick={() => scrollReset()}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            <li className={s.moduleItem}>
              <Link to='/dashboard/story' onClick={() => scrollReset()}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
        ...
        <div>
          <h5>Others</h5>
          <ul className={s.subModuleList}>
            <li>
              <Link to='/dashboard/navigation-links'>
                Navigation Links
              </Link>
            </li>
          </ul>
