...
- set table name
- set Yup validation
- set initialValues, emptyFormValues & payload
- set inputs
- update table
*/
      ...
      >
        {({ errors, touched, isSubmitting }) => {
          return (
            <Form>
              <div>
                <Input displayName='String' error={errors.title} touched={touched.title} input={{ type: 'text', name:'string', id:'string', required: true }}/>
                <Input displayName='Number' error={errors.title} touched={touched.title} input={{ type: 'number', name:'number', id:'number', required: true }}/>
